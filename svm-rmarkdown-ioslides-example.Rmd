---
title: Пример презентации в R Markdown
subtitle: (здесь может быть подзаголовок)
author: Стивен Миллер
institute: Департамент политической науки
...
# Поп-песни и политическая наука

## Шина Истон и теория игр
...
## Политическая платформа Рика Асли
...
## Карибская королева и операция *Чрезвычайная ярость*
