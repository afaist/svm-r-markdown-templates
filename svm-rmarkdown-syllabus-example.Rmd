...
title: "Введение в написание учебных планов на R Markdown"
author: Steven V. Miller и Алексей Кнорре
date: "Зима 2018"

email: "svmiller@clemson.edu"
...
myopts <- BibOptions(bib.style = "authortitle", style="latex", first.inits=FALSE, max.names = 20)
...
Attend <- data.frame(rgrade = round(runif(n = 100, 0, 100),0),
                     perattend = round(runif(n = 100, 0, 100),0),
                     name = round(runif(n = 100, 0, 100),0),
                     id = round(runif(n = 100, 0, 100),0),
                     term = round(runif(n = 100, 0, 100),0),
                     class = round(runif(n = 100, 0, 10),0))
...
##  `r advdate(mon, 4)`: Read Bib Item No. 16
...
##  `r advdate(mon, 5)`: The Fourth Topic with Bib Item No. 20
