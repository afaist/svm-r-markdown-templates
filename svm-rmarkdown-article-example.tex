...
\title{Шаблон и руководство по началу работы с вёрсткой статей в Markdown и
Pandoc \thanks{Оригинальный шаблон и файлы для репликации находятся здесь
(\url{http://github.com/svmiller}). \textbf{Текущая версия}: Февраль 01,
2018; \textbf{Связь с автором оригинала}:
\href{mailto:svmille@clemson.edu}{\nolinkurl{svmille@clemson.edu}}.;
\textbf{связь с автором перевода}:
\href{mailto:aknorre@eu.spb.ru}{\nolinkurl{aknorre@eu.spb.ru}}.}  }



\author{\Large Steven V. Miller\vspace{0.05in} \newline\normalsize\emph{Clemson University}   \and \Large Алексей Кнорре\vspace{0.05in} \newline\normalsize\emph{Европейский Университет в Санкт-Петербурге}  }
...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Steven V. Miller (Clemson University) and Алексей Кнорре (Европейский Университет в Санкт-Петербурге)},
             pdfkeywords = {pandoc, r markdown, knitr},  
            pdftitle={Шаблон и руководство по началу работы с вёрсткой статей в Markdown и
Pandoc},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
...
\textbf{\authorfont Steven V. Miller} \hskip 15pt \emph{\small Clemson University}   \par \textbf{\authorfont Алексей Кнорре} \hskip 15pt \emph{\small Европейский Университет в Санкт-Петербурге}   
...
\noindent Этот текст является введением в R Markdown, рассказывает про его
преимущества, и показывает, как студентам, учёным и преподавателям
делать статьи в R Markdown. Автором является Стивен Миллер, который
написал этот текст по-английски с примерами базового синтаксиса R
Markdown и дал минимальный рабочий шаблон того, как можно проводить
анализ данных в R с помощью пакета \texttt{knitr}. Алексей Кнорре
изменил шаблон (теперь он собирается в PDF даже с русским языком) и
немного перевёл начало.
...
\NormalTok{    template}\OperatorTok{:}\StringTok{ }\NormalTok{svm}\OperatorTok{-}\NormalTok{latex}\OperatorTok{-}\NormalTok{ms.tex}
...
\NormalTok{bibliography}\OperatorTok{:}\StringTok{ }\NormalTok{master.bib}
